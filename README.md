...
https://dev.axiomide.com/marketplace/christiangeorgelucas/graph-tools@0.9.0
...
```bash
axiom invoke christiangeorgelucas/graph-tools/ShortestPath --input '{ ... }'
```

**Call it over HTTP.**

```bash
curl -X POST https://api.axiomide.com/invocations/v1/nodes/christiangeorgelucas/graph-tools/0.9.0/ShortestPath \
...
> `axiom inspect node christiangeorgelucas/graph-tools/ShortestPath`.
